...
namespace test.ChatMessageUtilities
{
    ...
    public class ChatMessageTest
    {
        ...
        {
            var msg = new ChatMessageEntity(new DateTime(), null, null, null);
            Assert.AreEqual(msg.Speaker, "");
            Assert.AreEqual(msg.Text, "");
            Assert.AreEqual(msg.MessageTimeStamp, new DateTime());
        }
        ...
        {
            var msg = new ChatMessageEntity(new DateTime(2012, 12, 11, 10, 9, 8), "TestSpeaker", "This is a test string", "all");
